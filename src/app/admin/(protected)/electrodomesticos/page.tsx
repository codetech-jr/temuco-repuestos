...
async function fetchAdminElectrodomesticosFromAPI(
  page: number = 1,
  ...
  brandFilter: string = '',
  statusFilter: string = ''
): Promise<{ data: ElectrodomesticoListItem[], totalItems: number, totalPages: number, currentPage: number, error: string | null }> {
...
export default function AdminElectrodomesticosPage() {
  ...
  useEffect(() => {
    loadElectrodomesticos(currentPage);
  }, [currentPage, loadElectrodomesticos]);
