...
import Link from 'next/link'; // Para el enlace a la política de privacidad si es una página interna

const TermsAndConditionsPage = () => {
  // Puedes poner estas variables en un .env o archivo de configuración si lo prefieres
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-800 shadow-xl rounded-lg p-6 sm:p-10">
          ...
          <section className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div className="pt-6">
              ...
              <p>
                Este catálogo tiene como finalidad principal la exhibición y promoción de:
              </p>
            ...
            <div className="pt-6">
              ...
              <p>
                ...
                {/* Si es un enlace externo, usa:
                <a href="[URL de tu Política de Privacidad]" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">
                  nuestra Política de Privacidad
                </a>
                */}
              </p>
