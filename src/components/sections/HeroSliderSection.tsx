...
const slidesData: SlideContent[] = [
    // ... tu data de slides no cambia ...
    {
        ...
        subtitle: "Reparaciones eficientes que te devuelven el tiempo, y una garantía que te da total tranquilidad.",
      ...
      },
      {
        ...
        title: "La Pieza Perfecta para tu Presupuesto",
        subtitle: "La calidad que exiges o el precio que buscas. Tú decides cómo darle una nueva vida a tu equipo.",
      ...
      },
      {
        ...
        title: "Tu Clima Perfecto, Todo el Año",
        subtitle: "Creamos el ambiente perfecto para tu hogar y oficina. Disfruta del confort ideal durante todo el año.",
      ...
      },
      {
        ...
        title: "Tu Hogar, Más Inteligente y Eficiente",
        subtitle: "Descubre lo último en refrigeración, línea blanca y climatización para una vida más fácil y eficiente.",
      ...
      },
      {
        ...
        title: "Compra con la Confianza de un Experto",
        subtitle: "Te ayudamos a elegir el equipo perfecto para tus necesidades y presupuesto, asegurando que tu inversión valga la pena.",
      ...
      },
      {
        ...
        title: "Diagnóstico Preciso. Reparación Garantizada.",
        subtitle: "La rapidez que necesitas, con la eficacia que esperas. Tus aparatos reparados bien y a la primera.",
      ...
      },
      {
        ...
        subtitle: "Alarga la vida de tus aparatos. La calidad original es la única que te garantiza no volver a gastar en lo mismo.",
